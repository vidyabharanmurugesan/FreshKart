...
# Public routes
auth_bp.route('https://freshkart-lg0l.onrender.com/api/auth/signup', methods=['POST'])(signup)
auth_bp.route('https://freshkart-lg0l.onrender.com/api/auth/login', methods=['POST'])(login)
...
# Protected routes
auth_bp.route('https://freshkart-lg0l.onrender.com/api/auth/me', methods=['GET'])(jwt_required()(get_current_user))
